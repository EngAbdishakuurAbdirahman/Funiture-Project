            ...
            <form className="grid grid-cols-1 gap-6 flex-grow">
              ...
              <div>
                <motion.button
                  ...
                  type="submit"
                  className="w-full bg-gradient-to-r to-[#fdf0d5] from-[#022538] text-white font-semibold py-2 px-4 rounded-lg hover:from-[#fdf0d5] hover:to-[#022538] transition duration-300"
