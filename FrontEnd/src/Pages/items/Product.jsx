...
//           </div>
//           <motion.button  className="w-full bg-[#183b50] text-white text-lg py-2 rounded-lg shadow-md flex justify-center items-center gap-2 transition-all duration-300 hover:bg-[#183b50] hover:scale-105" whileTap={{ scale: 0.95 }}> Add to Cart <i className="fa-solid fa-cart-shopping"></i>
//           </motion.button>
//         </div>
//       </motion.div>
//       {/* Second */}
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-10">
        ...
        >
          ...
          <div className="p-4 space-y-2">
            ...
            <motion.button onClick={() => navigate('/LuxuryLiving')} className="w-full bg-[#183b50] text-white text-lg py-2 rounded-lg shadow-md flex justify-center items-center gap-2 transition-all duration-300 hover:bg-[#0f2b3a] hover:scale-105" whileTap={{ scale: 0.95 }}>Add to Cart <i className="fa-solid fa-cart-shopping"></i>
            </motion.button>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="p-4 space-y-2">
            ...
            <motion.button onClick={() => navigate('/VIPLiving')} className="w-full bg-[#183b50] text-white text-lg py-2 rounded-lg shadow-md flex justify-center items-center gap-2 transition-all duration-300 hover:bg-[#0f2b3a] hover:scale-105" whileTap={{ scale: 0.95 }} >Add to Cart <i className="fa-solid fa-cart-shopping"></i>
            </motion.button>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="p-4 space-y-2">
            ...
            <motion.button onClick={() => navigate('/SpecialLiving')} className="w-full bg-[#183b50] text-white text-lg py-2 rounded-lg shadow-md flex justify-center items-center gap-2 transition-all duration-300 hover:bg-[#0f2b3a] hover:scale-105" whileTap={{ scale: 0.95 }}> Add to Cart <i className="fa-solid fa-cart-shopping"></i>
            </motion.button>
          </div>
        </motion.div>
        ...
        <motion.div className="border border-gray-300 rounded-lg overflow-hidden shadow-lg bg-white p-4"  initial={{ opacity: 0, y: 20 }}  animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} whileHover={{ scale: 1.05 }}>
          ...
          <div className="p-4 space-y-2">
            ...
            <motion.button className="w-full bg-[#183b50] text-white text-lg py-2 rounded-lg shadow-md flex justify-center items-center gap-2 transition-all duration-300 hover:bg-[#0f2b3a] hover:scale-105" whileTap={{ scale: 0.95 }}> Add to Cart <i className="fa-solid fa-cart-shopping"></i>
            </motion.button>
          </div>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-7">
        ...
        >
          ...
          <motion.button onClick={() => navigate('/LuxuryBed')}  className="w-full bg-[#183b50] text-white text-lg py-2 rounded-lg shadow-md flex justify-center items-center gap-2 transition-all duration-300 hover:bg-[#0f2b3a] hover:scale-105"whileTap={{ scale: 0.95 }}>Add to Cart <i className="fa-solid fa-cart-shopping"></i>
            </motion.button>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="p-4 space-y-2">
            ...
            <motion.button onClick={() => navigate('/VIPBed')}className="w-full bg-[#183b50] text-white text-lg py-2 rounded-lg shadow-md flex justify-center items-center gap-2 transition-all duration-300 hover:bg-[#0f2b3a] hover:scale-105" whileTap={{ scale: 0.95 }}> Add to Cart <i className="fa-solid fa-cart-shopping"></i>
            </motion.button>
          </div>
        </motion.div>
        ...
        <motion.div className="border border-gray-300 rounded-lg overflow-hidden shadow-lg bg-white p-4" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} whileHover={{ scale: 1.05 }} >
          ...
          <div className="p-4 space-y-2">
            ...
            <motion.button onClick={() => navigate('/TurkishBed')} className="w-full bg-[#183b50] text-white text-lg py-2 rounded-lg shadow-md flex justify-center items-center gap-2 transition-all duration-300 hover:bg-[#0f2b3a] hover:scale-105" whileTap={{ scale: 0.95 }}>Add to Cart <i className="fa-solid fa-cart-shopping"></i>
            </motion.button>
          </div>
        </motion.div>
      </div>
